"""Setup script for Hierarchical Active Inference with Successor Representations."""
...
setup(
    name="hierarchical-active-inference",
    version="1.0.0",
    author="Prashant Rangarajan",
    description="Hierarchical Active Inference using Successor Representations",
